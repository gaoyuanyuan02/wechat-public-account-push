...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'oMEeO5_XtkDmLAZdlRICCLQFI4f8',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'kQH-SrTnSaSXdMVTBEd2eJrTG4tFgZH-qzLnyPsGN8A',
      // 所在省份
      province: '河北',
      // 所在城市
      city: '石家庄',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2002', date: '11-05',
        },
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2016-02-20' },
  ...
  CALLBACK_TEMPLATE_ID: 'kQH-SrTnSaSXdMVTBEd2eJrTG4tFgZH-qzLnyPsGN8A',
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '老婆', year: '2002', date: '11-05', isShowAge: true,
    },
